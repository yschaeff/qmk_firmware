...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    [0] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU),  ENCODER_CCW_CW(LCTL(KC_LEFT), LCTL(KC_RIGHT))  },
    [1] = { ENCODER_CCW_CW(XXXXXXX, XXXXXXX),  ENCODER_CCW_CW(XXXXXXX, XXXXXXX)  },
    [2] = { ENCODER_CCW_CW(XXXXXXX, XXXXXXX),  ENCODER_CCW_CW(KC_UP, KC_DOWN)  },
...
[_QWERTY] = LAYOUT_ffkb(
  ...
  _______, KC_Z,         KC_X,         KC_C,         KC_V,         KC_B,         KC_N,    KC_M,         KC_COMM,      KC_DOT,       KC_SLSH,          LCTL(KC_RBRC),
           KC_MUTE,                    _______,      KC_RALT,      LOWER,        RAISE,   KC_SPC,       KC_BSLS,                    LCTL(KC_BSPC)
),
...
[_LOWER] = LAYOUT_ffkb(
  ...
  _______, KC_LABK, KC_LCBR, KC_LBRC, KC_LPRN, KC_UNDS,      KC_MINS, KC_RPRN, KC_RBRC, KC_RCBR, KC_RABK, _______,
