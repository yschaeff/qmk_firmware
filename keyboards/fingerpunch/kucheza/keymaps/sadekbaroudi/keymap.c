...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_GAME] = LAYOUT_wrapper( \
    ...
    __GAMES_R3_L__,     ___________________GAMES_3_________________,                                               KC_VOLU, \
    __GAMES_R4_1__, __GAMES_R4_2__, MO(_FUNCTION),      __GAMES_R4_3__, __GAMES_TH_L__, __GAMES_TH_C__,   KC_MPRV, KC_MPLY, KC_MNXT,  \
                                                                                                                   KC_VOLD, \
  ...
  [_FUNCTION] = LAYOUT_wrapper( \
    ...
    KC_LSFT, KC_RGB_T,   RGB_HUD,          RGB_SAD,           RGB_VAD,  RGB_SPD,                                KC_VOLU, \
    KC_LCTL, KC_LGUI,   _______,                              KC_LALT,  KC_BSPC,   KC_SPC,             KC_MPRV, KC_MPLY, KC_MNXT,  \
                                                                                                                KC_VOLD, \
                                                   KC_VOLD,   KC_MUTE,   KC_VOLU, \
    KC_LSFT \
  ),
  ...
  [_KICAD] = LAYOUT_wrapper( \
    ...
    __KICAD_R3_L__,     ___________________KICAD_3_________________,                                             KC_VOLU, \
    __KICAD_R4_1__, __KICAD_R4_2__, TG(_KICAD),    __KICAD_R4_3__, __KICAD_TH_L__, __KICAD_TH_C__,      KC_MPRV, KC_MPLY, KC_MNXT,  \
                                                                                                                 KC_VOLD, \
                                                   KC_VOLD,   KC_MUTE,   KC_VOLU, \
    KC_LSFT \
  ),
  ...
  [_FUSION] = LAYOUT_wrapper( \
    ...
    KC_LCTL, KC_LGUI, TG(_FUSION), KC_LALT,             KC_BSPC,  KC_SPC,      KC_MPRV, KC_MPLY, KC_MNXT,  \
                                                                                        KC_VOLD, \
                               KC_VOLD,   KC_MUTE,   KC_VOLU, \
    KC_LSFT \
  ),
