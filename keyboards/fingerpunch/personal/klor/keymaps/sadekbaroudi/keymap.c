...
#define LAYOUT_klor_base( \
  ...
  LAYOUT_wrapper( \
        ...
        _______, LCTL_T(K01),    LGUI_T(K11),    LALT_T(K21),    LSFT_T(K31),            K41,                      LT(_MOUSE, K45),       RSFT_T(K35),           RALT_T(K25),      RGUI_T(K15),    RCTL_T(K05), _______, \
        _______, K02,            K12,            K22,            K32,                    K42,   _______, _______,  K46,                   K36,                   K26,              K16,            K06,         _______, \
                                            K23,   LT(_NAVIGATION,K33),    LT(_FUNCTION,K43),   _______, _______,      LT(_MEDIA,K47),     LT(_SYMBOLS,K37),  K27 \
    )
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FUNCTION] = LAYOUT_wrapper(
        ...
        _______, ________________SHIFTNAV_3_________________, _______, _______, ________________FUNCTION_3_________________, _______,
                                   _______, _______, _______, _______, _______, N_DEL_LINE, KC_SPACE, _______
    ),
